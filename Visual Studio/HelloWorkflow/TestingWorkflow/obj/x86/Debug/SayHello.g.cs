...
namespace HelloWorkflow {
    ...
    public partial class SayHello : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _Username;
        
        private System.Activities.OutArgument<string> _Greeting;
        ...
        public System.Activities.OutArgument<string> Greeting {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SayHello).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SayHello));
        ...
        private string FindResource() {
            string[] resources = typeof(SayHello).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SayHello.g.xaml") || resource.Equals("SayHello.g.xaml"))) {
                    return resource;
                }
            }
